...
Der [Software-Hygiene-Teil]({{<ref "hygiene.md">}}) hat uns gezeigt, warum es wichtig ist, eine möglichst kleine Angriffsfläche zu bieten. Für die produktive Nutzung eines Laptops, PCs oder Smartphones ist jedoch dennoch zusätzliche Software nötig. Doch wie geht man mit dieser Software um?
...
Ein ausführliches Video über die Hintergründe und Auswirkungen von Computerphile findet sich hier: https://www.youtube.com/watch?v=88jkB1V6N9w
...
| Paketmanager       | automatisch; halbautomatisch                   | apt, winget, Homebrew                   | Batch‑Updates              | **Nur für technisch Interessierte/Versierte geeignet** UnigetUI |

## Empfehlungen

Was sollte man nun konkret umsetzen, um die Software möglichst schnell zu aktualisieren?

Überall, wo die Option angeboten wird, automatische Updates aktivieren. Das verhindert, dass Updates vergessen werden, man gerade keine Zeit dafür hat oder Angst vor einem Update hat.
Das gilt insbesondere für das **Betriebssystem**.
...
- Zudem sollten auch Updates für Software beachtet werden, die nicht in der „ersten Reihe” steht.
  ...
  - Router-Firmware.
  - Bibliotheken, die manche Software mitinstalliert, beispielsweise das Java Runtime Environment.
  - ...
    Bei manuellen Downloads sollte genau geprüft werden, ob es sich um die offiziellen Herstellerseiten handelt. App-Store-Updates sollten für alle Apps aus App-Stores erlaubt werden [Sichere Quellen]({{<ref "quellen.md">}}).
